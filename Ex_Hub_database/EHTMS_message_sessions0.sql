...
--
-- Dumping data for table `message_sessions`
--

LOCK TABLES `message_sessions` WRITE;
/*!40000 ALTER TABLE `message_sessions` DISABLE KEYS */;
/*!40000 ALTER TABLE `message_sessions` ENABLE KEYS */;
UNLOCK TABLES;
