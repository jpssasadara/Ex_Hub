...
import {AuthenticationAuthGaurdService} from './DemoPages/Services/AuthGaurd/PageRoutingAuthGard_For_AuthenticationOnly/authentication-auth-gaurd.service';
import {UserManagementViewComponent} from './DemoPages/UserManagement/user-management-view/user-management-view.component';
import {AuthenticationAndAuthorizationService} from './DemoPages/Services/AuthGaurd/PageRoutingAuthGard_For_AuthenticationAndAuthorization/authentication-and-authorization.service';
...
const routes: Routes = [
  ...
  {path: '', component: LoginBoxedComponent, data: {extraParameter: ''}},
  {
    ...
    children: [
      // Registration
      {path: 'ViewUser/VIEW/show', component: UserManagementViewComponent, data: {extraParameter: 'dashboardsMenu'}, canActivate: [AuthenticationAndAuthorizationService]},
      // Dashboads
